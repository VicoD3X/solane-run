export type ServiceType = "Pochven" | "Thera" | "HighSec" | "LowSec" | "NpcNullSec" | "Zarzakh";
...
export type RouteRiskLevel = "nominal" | "watched" | "hot" | "flashpoint" | "critical" | "unavailable";
...
export type RouteRiskSummary = {
  ...
  label: "Nominal" | "Watched" | "Hot" | "Flashpoint" | "Critical" | "Unavailable";
  isBlocking: boolean;
  reason: string | null;
